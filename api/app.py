...
class ApprovedRequests(Resource):
    def get(self):
        ...
        leave_requests=LeaveApplication.query.filter_by(LeaveApplication.hod_status=="Approved" and LeaveApplication.gm_status=="Approved" and LeaveApplication.hr_status=="Approved").all()

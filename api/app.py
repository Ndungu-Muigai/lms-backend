...
class LeaveApplications(Resource):
    ...
    def post(self):
        ...
        if employee_role == "User":
            ...
            print(superior)
            send_submitted_application(fullName=superior.fullName(), email=superior.email, startDate=start_date, endDate=end_date, duration=leave_duration, applicationID=new_application.id)

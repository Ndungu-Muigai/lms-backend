...
redis_pool = redis.ConnectionPool(host=os.getenv("KV_URL"), db=0, decode_responses=True, socket_timeout=5)
app.config['SESSION_REDIS'] = redis.from_url(os.getenv("KV_REST_API_URL"))
